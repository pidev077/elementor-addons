        ...
        $this->add_responsive_control(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .secondary-ctas-elements .list-items .item .thumbnail img' => 'width: {{SIZE}}{{UNIT}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .secondary-ctas-elements .list-items .item .thumbnail img' => 'max-width: {{SIZE}}{{UNIT}}',
                    ],
                ]
            );
